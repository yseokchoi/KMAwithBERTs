...
class ModelSaver(ModelSaverBase):
    ...
    def _save(self, step, model):
        ...
        model_state_dict = {k: v for k, v in model_state_dict.items() if 'generator' not in k or 'separator' not in k}
        gen_state_dict = model.generator.state_dict()
        sep_state_dict = model.separator.state_dict()
        ...
        checkpoint = {
            ...
            'generator': gen_state_dict,
            'separator': sep_state_dict,
            'opt': self.model_opt,
            'optim': self.optim.state_dict(),
        }

        print("Saving checkpoint %s_epoch_%d.pt" % (self.base_path, step))
        checkpoint_path = '%s_epoch_%d.pt' % (self.base_path, step)
